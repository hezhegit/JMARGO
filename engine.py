...
def train(args, net, criterion, train_loader, valid_loader, test_loader, ckpt_dir, F_txt, device):
    ...
    for epoch in range(best_epoch, args.num_epochs):
        ...
        print(
            ...
            "F-score:{:.4f}".format(
                epoch + 1, train_loss_all, valid_loss, valid_auc, valid_fmax, test_loss, test_auc, test_fmax), file=F_txt)
        F_txt.flush()
    ...
    np.save(ckpt_dir + "Epoch_{}".format(args.num_epochs), Loss)
